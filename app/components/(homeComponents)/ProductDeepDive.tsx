...
export default function ProductDeepDive() {
    ...
    <div className="w-full space-y-32 py-20">
      ...
      <section className="space-y-12">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#C7A86C] mb-4">
            RÜH-ARMOR™ — Five Pillar Matrix
          </h2>
        </div>
          ...
          {pillars.map((pillar, index) => {
            return (
              <button
                ...
                className={`px-6 cursor-pointer py-3 rounded-lg border-2 transition-all flex items-center gap-2 ${
                  activePillar === index
                    ? "bg-[#1a3a2e] text-white border-[#C7A86C]"
            ...
            <div className="relative">
              <div className="w-48 h-48 bg-linear-to-br from-[#1a3a2e] to-[#2d5a4a] rounded-2xl flex items-center justify-center shadow-2xl">
                {(() => {
                  ...
                  return <IconComponent className="w-24 h-24 text-[#C7A86C]" />;
                })()}
              </div>
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <ul className="space-y-3">
              {pillars[activePillar].points.map((point, i) => (
                <li key={i} className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#C7A86C] rounded-full mt-2 shrink-0"></div>
            ...
            <div className="mt-6 p-4 bg-[#f0f7f4] border-l-4 border-[#8fb996] rounded">
              <p className="text-[#1a3a2e] font-medium">
                <span className="text-[#C7A86C]">BENEFIT:</span> {pillars[activePillar].benefit}
              </p>
            </div>
          </div>
        </div>
            ...
            return (
              <div
                ...
                className={`p-6 rounded-xl border-2 cursor-pointer transition-all ${
                  activePillar === index
                    ? "bg-[#1a3a2e] text-white border-[#C7A86C] shadow-lg"
                    : "bg-gray-50 border-gray-200 hover:border-[#8fb996]"
                }`}
              >
                <pillar.icon className={`w-10 h-10 mb-4 ${activePillar === index ? "text-[#C7A86C]" : "text-[#1a3a2e]"}`} />
      ...
      <section className="space-y-12">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-semibold text-[#C7A86C] mb-2">
  ...
  {targetAreas.map((area, index) => {
    return (
      <div
        key={index}
        className="bg-gray-50 border-2 border-gray-200 rounded-xl p-6 hover:border-[#C7A86C] hover:shadow-lg transition-all"
      >
        {/* Icon and Title side by side */}
        <div className="flex items-start gap-4 mb-4">
          <div className="w-12 h-12 bg-[#1a3a2e] rounded-lg flex items-center justify-center shrink-0">
            <area.icon className="w-6 h-6 text-[#C7A86C]" />
          </div>
        ...
        <div className="bg-linear-to-r from-[#1a3a2e] to-[#2d5a4a] border-4 border-[#C7A86C] rounded-xl p-8 shadow-2xl">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-16 h-16 bg-[#C7A86C] rounded-full flex items-center justify-center shrink-0">
              <Shield className="w-8 h-8 text-[#1a3a2e]" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-[#C7A86C] mb-2">
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#1a3a2e] text-white">
                ...
                <th className="py-4 px-6 text-center font-bold text-[#C7A86C]">IMPROVEMENT</th>
              </tr>
            </thead>
            <tbody>
              {comparison.map((row, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-6 text-center font-bold text-[#C7A86C] text-xl">
                    {row.improvement}
                  </td>
                </tr>
              ))}
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              <div className="w-full aspect-square bg-linear-to-br from-[#1a3a2e] to-[#2d5a4a] rounded-2xl flex items-center justify-center shadow-2xl">
                <Zap className="w-32 h-32 text-[#C7A86C]" />
              </div>
              <div className="absolute -inset-4 bg-linear-to-r from-[#5cfaff]/20 to-[#C7A86C]/20 rounded-3xl blur-2xl -z-10"></div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <div className="w-3 h-3 bg-[#C7A86C] rounded-full mt-1.5 shrink-0"></div>
