...
export function PremiumLeaf({ className }: VectorProps) {
    return (
        ...
        >
            ...
            <path d="M50 80L35 65" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
            <path d="M50 65L30 50" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
            <path d="M50 50L35 38" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
            {/* Secondary Veins Right */}
            <path d="M50 80L65 65" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
            <path d="M50 65L70 50" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
            <path d="M50 50L65 38" stroke="currentColor" strokeWidth="0.8" opacity="0.3" />
        </svg>
    );
}
