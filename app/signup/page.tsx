            ...
            <div className="w-full max-w-lg z-10">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-2xl shadow-2xl relative group overflow-hidden">
                    ...
                    <div className="text-center mb-6 relative z-10">
                        ...
                        <p className="text-gray-400 text-sm">Join the Gold-Standard in clinical health</p>
                    </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/field">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors p-2"
                                >
                                    {showConfirmPassword ? <ICONS.X size={18} /> : <ICONS.Menu size={18} />}
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-white/5 text-center relative z-10">
                        <p className="text-gray-400 text-sm">
                            ...
                            <Link href="/login" className="text-(--luxe-gold) font-bold hover:text-(--soft-glow-green) transition-colors ml-1">
                                Log in
                            </Link>
                        </p>
                    </div>
                ...
                <div className="mt-8 text-center text-gray-500 text-sm">
                    &copy; {new Date().getFullYear()} Hijama Protocol. Excellence in Modern Medicine.
                </div>
            </div>
        </div>
    );
